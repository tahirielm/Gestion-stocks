...
if(isset($_GET['client'])){
	$sql = "UPDATE users SET type = 'client' WHERE id = ".$_GET['client'];
	if(mysqli_query($link, $sql)){
		header("Location: fournisseurs.php");
	}
	mysqli_close($link);
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	$sql = "INSERT INTO users (nom, prenom, adresse, telephone, email, type) VALUES (?, ?, ?, ?, ?, 'fournisseur') ;";
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<?php
						$query = "SELECT * FROM users WHERE type = 'fournisseur' ; ";
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="modify.php" method="POST">
												...
												<input type="text" class="visually-hidden" name="type" value="fournisseur">	
												<div class="form mb-3">
													<label>Nom</label>
							...
							<tbody>
								<tr>
									...
									<td><a class="btn btn-sm btn-outline-danger" href="?remove=<?php echo $row['id'] ?>" >Supprimer</a>
										<a class="btn btn-sm btn-outline-primary" href="?client=<?php echo $row['id'] ?>" >Rendre client</a>
