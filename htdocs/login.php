	...
	<div class="container col-xl-10 col-xxl-8 px-4 py-5">
		<div class="row align-items-center g-lg-5 py-5">
			<div class="col-lg-7 text-center text-lg-start">
				<h1 class="display-4 fw-bold lh-1 mb-3">Se Connecter</h1>
			</div>
			<div class="col-md-10 mx-auto col-lg-5">
				<?php if(isset($error) and $error == 'error') :?>
					<div class='alert alert-danger alert-dismissible fade show' role='alert'> Nom d'utilisateur ou mot de passe érronés!<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>
				<?php endif?>
				<form class="p-4 p-md-5 border rounded-3 bg-light shadow-lg" action="login.php" method="POST">
					<div class="form-floating mb-3">
						<input type="text" class="form-control" id="floatingUser" placeholder="Nom d'utilisateur" name="username" required>
						<label for="floatingUser">Nom d'utilisateur</label>
					</div>
					<div class="form-floating mb-3">
